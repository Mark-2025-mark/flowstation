...
// ── State + WS ────────────────────────────────────────────────────────────
let ws=null,state={ms:{},calls:{},emergencies:{},lastHeard:[],sdsLog:[],dapnetLog:[],echolinkDirectory:[],echolinkDirectoryStatus:'unknown',geoalarmEvents:[],geoalarmConfig:null,meshcomNodes:[],meshcomMessages:[],brewOnline:false,brewVer:0,brewStatus:null,brewStatusLoadedAt:0},sdsDest=0;
...
let healthIntegrationState={brew:null,asterisk:null,dapnet:null,echolink:null,geoalarm:null,meshcom:null,lastLoad:0};
// title, iconKey (brew|asterisk|dapnet|echolink|geoalarm), accent (blue|purple|''), level, detail, extra.
...
async function loadHealthIntegrations(){
  ...
  try{
    const [brew,ast,dap,el,geo,mesh]=await Promise.all([
